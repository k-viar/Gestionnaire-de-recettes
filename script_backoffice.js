...
const addButton = document.getElementById("add-a-recipe");
...
firstCourseButton.addEventListener("click", () => {
    firstCourseButton.style.borderBottom = "5px solid black";
...
mainMealButton.addEventListener("click", () => {
    mainMealButton.style.borderBottom = "5px solid black";
...
dessertsButton.addEventListener("click", () => {
    dessertsButton.style.borderBottom = "5px solid black";
...
if (newRecipe !== null) {
    ...
    if (typeOfDish === "Entrée") {
        ...
        imgChronometer.setAttribute("src", "Media/icone_temps_white.svg");
